        ...
        <section className="section">
          <div className="shell">
            ...
            <div className="notice notice-info" style={{ marginTop: 16 }}>
              ...
              911에 연락하십시오. <Link href="/ko/emergency">긴급상황 안내 보기 →</Link>
            </div>
          </div>
        </section>
            ...
            <div className="card-grid cols-2">
              <div className="card">
                ...
                <div style={{ marginTop: 20 }}>
                  <Link className="button button-navy" href="/ko/process">
                    이용 절차 보기
                  </Link>
                </div>
              </div>
              <div className="card">
                ...
                <div style={{ marginTop: 20 }}>
                  <Link className="button button-outline" href="/ko/consultation-prep">
                    상담 준비 안내
                  </Link>
                </div>
              </div>
