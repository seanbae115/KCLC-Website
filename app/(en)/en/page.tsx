        ...
        <section className="hero" id="top">
          ...
          <div className="shell hero-grid">
            <div className="hero-copy">
              <p className="eyebrow">KOREAN SENIOR LIFE CAMPUS</p>
              <h1>
                Start getting help
                <br />
              ...
              <div className="hero-actions">
                ...
                <Link className="button button-outline" href="/en/services" style={{ borderColor: "rgba(255,255,255,.5)", color: "white" }}>
                  View Services
                </Link>
                <Link className="text-link" href="/en/referral">
            ...
            <div className="hero-mark" aria-hidden="true">
              ...
              <div className="service-note note-one">
                <strong>ONE DOOR</strong>
                <span>Where help begins</span>
              </div>
              <div className="service-note note-two">
                <strong>MANY SERVICES</strong>
                <span>Connected to what you need</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="services section" id="services">
          <div className="shell">
            ...
            <div style={{ textAlign: "center", marginTop: 40 }}>
              <Link className="button button-navy" href="/en/services">
                View All Services
              </Link>
            </div>
          </div>
        ...
        <section className="partners section" id="partners">
          <div className="shell partners-grid">
            ...
            <div>
              ...
              <Link className="text-link dark" href="/en/partnership">
        ...
        <section className="resources section" id="resources">
          <div className="shell resource-card">
            ...
            <div className="resource-action">
              ...
              <Link className="button button-navy" href="/en/resources">
                Visit Resources
              </Link>
        ...
        <section className="section-tight">
          <div className="shell contact-card" style={{ background: "var(--warm)", color: "var(--charcoal)", boxShadow: "none", border: "1px solid var(--rule)" }}>
            ...
            <div className="contact-actions">
              <Link className="button button-gold" href="/en/partnership#donate">
                Donate
              </Link>
              <Link className="button button-outline" href="/en/partnership#volunteer">
                Volunteer
              </Link>
            </div>
          </div>
          ...
          <div className="shell contact-card">
            ...
            <div className="contact-actions">
              ...
              <a
                ...
                href="https://www.google.com/maps/search/?api=1&query=6291+Homewood+Ave+Buena+Park+CA+90621"
                target="_blank"
                rel="noreferrer"
              >
                6291 Homewood Ave.
